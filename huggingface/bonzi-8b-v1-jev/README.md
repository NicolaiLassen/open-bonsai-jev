...
**Bonsai 1 8B as a typed decision function.** No weights here. This is a
recipe and a measurement for running
[`prism-ml/Bonsai-8B-gguf`](https://huggingface.co/prism-ml/Bonsai-8B-gguf) as a
...
```json
{"choice": "true", "probabilities": {"true": 0.999554, "false": 0.000446},
 "label_mass": 0.999932, "prompt_tokens": 93, "forward_s": 0.163}
```
...
| | |
|---|---|
| Weights | [`Bonsai-8B-Q1_0.gguf`](https://huggingface.co/prism-ml/Bonsai-8B-gguf/blob/main/Bonsai-8B-Q1_0.gguf) |
| Quantization | 1-bit (`Q1_0`) |
| On disk | **1.16 GB** |
| Runtime | stock llama.cpp |
| WANLI-256 | **64.5%** (chance 33.3%) |
| easy100 | 98% |
| Throughput | 230 decisions/min |
| Median latency | 245 ms |
| Median `label_mass` | 1.000 |
...
Apple M4 Pro, GPU, ctx 4096, warmup excluded. This model ranks **#4 of
